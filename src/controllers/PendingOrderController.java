...
public class PendingOrderController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loggedIn == null || loggedIn.contentEquals("false")) {
			...
			//retrieve attribute cartItemList from sessionScope, item = {artikelnr, productnaam, gewicht, btw, artikelprijs, aantal, bedrag}
			List<String[]>cartItemList = (List<String[]>) session.getAttribute("cartItemList");
				
			//create orderArtikelDetails-list from cartItemList, item = {artikelnr, artikelprijs, aantal, stukgewicht, totaalgewicht, bedragExBtw, btw9, btw21, bedragIncBtw}
			...
			//totalOrderSpecification --> {artikelenTotaal, totaalBedragExBtw, btw9totaal, btw21totaal, orderGewicht(kg), aantalPaketten, verzendkosten, totaalIncVerzendkosten }
